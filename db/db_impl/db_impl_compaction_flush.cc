...
const std::string kManualCompactionJobName("manual_compaction");
  ...
  while (!manual.done) {
    ...
    if (ShouldntRunManualCompaction(&manual) || (manual.in_progress == true) ||
      ...
      if (compaction->bottommost_level() &&
        ...
        env_->Schedule(
            &DBImpl::BGWorkBottomCompaction, ca, Env::Priority::BOTTOM, this,
            &DBImpl::UnscheduleCompactionCallback, kManualCompactionJobName);
